...
//! [`aura_core_types::resolve_effective_permission`] into
//! [`aura_core_types::ToolState`] (`on` / `off` / `ask`). Capability, scope,
...
//! crates still import via `aura_agent_kernel::policy::{Policy, PolicyConfig,
//! PolicyResult}`.
