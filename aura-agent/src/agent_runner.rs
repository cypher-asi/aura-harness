...
impl Default for AgentRunnerConfig {
    fn default() -> Self {
        Self {
            ...
            default_model: "claude-opus-4-6-20250514".to_string(),
            simple_model: "claude-sonnet-4-20250514".to_string(),
        }
    }
}
...
impl AgentRunner {
    ...
    pub async fn execute_chat(
        ...
        let system_prompt = build_chat_system_prompt(project, custom_system_prompt);
    ...
    pub async fn execute_shell_task(
        ...
        anyhow::bail!("command `{command}` failed after {max_attempts} attempts")
    }
}
